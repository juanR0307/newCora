<?php
        ...
        $sql = "SELECT * FROM tests WHERE test_category = 'Self-Estimate 1' AND student_id = $id";
        ...
        $sql = "SELECT * FROM tests WHERE test_category = 'Self-Estimate 2' AND student_id = $id";
        $result = mysqli_query($conn, $sql);
