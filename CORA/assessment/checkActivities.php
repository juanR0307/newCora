...
require "../config/db.php";
    ...
    if(isset($_POST['submit'])) {
        ...
        foreach($selected as $qId) {
            ...
            $sql = "INSERT INTO answer (student_id, q_id, category) VALUES ($id, $qId, 'A1')";
            $result = mysqli_query($conn, $sql);
        }
        ...
        foreach($selected as $qId) {
            ...
            $sql = "INSERT INTO answer (student_id, q_id, category) VALUES ($id, $qId, 'S1')";
            $result = mysqli_query($conn, $sql);
        }
        ...
        foreach($selected as $qId) {
            ...
            $sql = "INSERT INTO answer (student_id, q_id, category) VALUES ($id, $qId, 'E1')";
            $result = mysqli_query($conn, $sql);
        }
        ...
        foreach($selected as $qId) {
            ...
            $sql = "INSERT INTO answer (student_id, q_id, category) VALUES ($id, $qId, 'C1')";
            $result = mysqli_query($conn, $sql);
        }
...
if(isset($_POST['submit'])) {
        ...
        echo $contentC;
            ...
            VALUES ($contentR, $contentI, $contentA, $contentS, $contentE, $contentC, 'Activities', $id)";
